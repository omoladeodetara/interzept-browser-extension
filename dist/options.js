...
const Tabs = Root2$2;
const TabsList = reactExports.forwardRef((_a, ref) => {
...
const TabsTrigger = reactExports.forwardRef((_c, ref) => {
...
const TabsContent = reactExports.forwardRef((_e, ref) => {
...
const Card = reactExports.forwardRef((_g, ref) => {
...
const CardHeader = reactExports.forwardRef((_i, ref) => {
...
const CardTitle = reactExports.forwardRef((_k, ref) => {
...
const CardDescription = reactExports.forwardRef((_m, ref) => {
...
const CardContent = reactExports.forwardRef((_o, ref) => {
...
const CardFooter = reactExports.forwardRef((_q, ref) => {
...
const Button = reactExports.forwardRef(
  (_s, ref) => {
    var _t = _s, { className, variant, size: size2, asChild = false } = _t, props = __objRest(_t, ["className", "variant", "size", "asChild"]);
...
const Input = reactExports.forwardRef(
  (_u, ref) => {
    var _v = _u, { className, type } = _v, props = __objRest(_v, ["className", "type"]);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      __spreadValues({
        type,
...
const Label$1 = reactExports.forwardRef((_w, ref) => {
...
var Portal$1 = reactExports.forwardRef((props, forwardedRef) => {
  ...
  const container2 = containerProp || mounted && ((_b = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _b.body);
  return container2 ? ReactDOM.createPortal(/* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.div, __spreadProps(__spreadValues({}, portalProps), { ref: forwardedRef })), container2) : null;
});
...
var Select$1 = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2$1, __spreadProps(__spreadValues({}, popperScope), { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, __spreadValues({ asChild: true }, props));
};
...
var BubbleSelect = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(VisuallyHidden, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", __spreadProps(__spreadValues({}, selectProps), { ref: composedRefs, defaultValue: value })) });
  }
);
...
const SelectTrigger = reactExports.forwardRef((_A, ref) => {
...
const SelectScrollUpButton = reactExports.forwardRef((_C, ref) => {
  var _D = _C, { className } = _D, props = __objRest(_D, ["className"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ScrollUpButton,
    __spreadProps(__spreadValues({
...
const SelectScrollDownButton = reactExports.forwardRef((_E, ref) => {
  var _F = _E, { className } = _F, props = __objRest(_F, ["className"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ScrollDownButton,
    __spreadProps(__spreadValues({
...
const SelectContent = reactExports.forwardRef((_G, ref) => {
  var _H = _G, { className, children, position = "popper" } = _H, props = __objRest(_H, ["className", "children", "position"]);
...
const SelectLabel = reactExports.forwardRef((_I, ref) => {
  var _J = _I, { className } = _J, props = __objRest(_J, ["className"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Label,
    __spreadValues({
...
const SelectItem = reactExports.forwardRef((_K, ref) => {
...
const SelectSeparator = reactExports.forwardRef((_M, ref) => {
  var _N = _M, { className } = _N, props = __objRest(_N, ["className"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Separator,
    __spreadValues({
...
const Textarea = reactExports.forwardRef((_O, ref) => {
  var _P = _O, { className } = _P, props = __objRest(_P, ["className"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "textarea",
    __spreadValues({
...
const MobileNotSupported = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-slate-900 text-slate-100 flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/icons/icon128.png", alt: "Interzept", className: "h-16 w-16 mx-auto mb-4" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white mb-2", children: "Interzept" })
  ] }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800 border border-slate-700 rounded-lg p-6 mb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-cyan-400 mb-3", children: "Desktop Only" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-300 mb-4", children: "Interzept is a browser extension designed for desktop development workflows. Mobile browsers don't support the extension APIs needed for request interception." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "Please visit this page on a desktop browser to use Interzept." })
  ] }),
...
function App() {
  ...
  const [activeRule, setActiveRule] = reactExports.useState(null);
  const [lockedTab, setLockedTab] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (searchQuery) {
  ...
  const createRuleFromTemplate = (templateId) => {
    const template = ruleTemplates[templateId];
    if (!template) return;
    const newRule = __spreadValues({
      id: Date.now().toString()
    }, template);
    setActiveRule(newRule);
    setEditMode(true);
  ...
  const updateActiveRule = (field, value) => {
    if (!activeRule) return;
    setActiveRule(__spreadProps(__spreadValues({}, activeRule), {
      [field]: value
    }));
  };
  const updateNestedField = (parentField, index2, field, value) => {
    if (!activeRule || !activeRule[parentField]) return;
    const updatedArray = [...activeRule[parentField]];
    updatedArray[index2] = __spreadProps(__spreadValues({}, updatedArray[index2]), {
      [field]: value
    });
    setActiveRule(__spreadProps(__spreadValues({}, activeRule), {
  ...
  const exportRules = () => {
    ...
    link.href = url;
    link.download = `interzept-rules-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.json`;
    link.click();
  ...
  const getRuleTypeIcon = (type) => {
    switch (type) {
      ...
      case "headers":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Heading, { className: "h-4 w-4" });
      case "overrides":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FileJson, { className: "h-4 w-4" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "h-4 w-4" });
    }
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto py-8 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-slate-800 border-slate-700", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-slate-100 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-5 w-5 text-cyan-400" }),
            "Rules (",
            filteredRules.length,
            ")"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-slate-400", children: "Manage your API interception rules" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          filteredRules.map((rule) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `group p-4 border rounded-lg cursor-pointer transition-all duration-200 ${rule.enabled ? "border-slate-600 bg-slate-700/50 hover:border-cyan-400/50 hover:bg-slate-700" : "border-slate-700 bg-slate-800/30 opacity-60"}`,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `p-2 rounded-lg ${rule.type === "overrides" ? "bg-cyan-500/10 text-cyan-400" : rule.type === "redirect" ? "bg-green-500/10 text-green-400" : "bg-purple-500/10 text-purple-400"}`,
                      children: getRuleTypeIcon(rule.type)
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-slate-100 truncate group-hover:text-cyan-400 transition-colors", children: rule.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 mt-1 capitalize", children: rule.type === "overrides" ? "Response Override" : rule.type === "redirect" ? "URL Redirect" : "Header Modification" }),
                    rule.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mt-1 line-clamp-2", children: rule.description })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "ghost",
                      ...
                      className: `h-6 w-11 rounded-full p-0 ${rule.type !== "overrides" ? "bg-slate-600/50 cursor-not-allowed opacity-50" : rule.enabled ? "bg-cyan-500 hover:bg-cyan-600" : "bg-slate-600 hover:bg-slate-500"}`,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `h-4 w-4 rounded-full bg-white transition-transform ${rule.type !== "overrides" ? "-translate-x-2.5 opacity-60" : rule.enabled ? "translate-x-2.5" : "-translate-x-2.5"}`
                        }
                      )
                    }
                  ),
          ...
          filteredRules.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-slate-400", children: searchQuery ? "No rules match your search." : 'No rules created yet. Click "New Rule" to get started.' })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: editMode && activeRule ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-slate-800 border-slate-700", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-slate-100", children: rules.some((r2) => r2.id === activeRule.id) ? "Edit Rule" : "Create New Rule" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-slate-400", children: "Configure how API requests should be intercepted and modified" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Tabs,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "rule-name", className: "text-slate-200", children: "Rule Name" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "rule-name",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-slate-200", children: "Template" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { onValueChange: createRuleFromTemplate, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "bg-slate-700 border-slate-600 text-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Choose template (optional)" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-slate-800 border-slate-600", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "api-mock", className: "text-slate-100 focus:bg-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "API Mock" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Mock API responses" })
                          ] }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "cors-bypass", className: "text-slate-100 focus:bg-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "CORS Bypass" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Add CORS headers" })
                          ] }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "auth-header", className: "text-slate-100 focus:bg-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "Auth Header" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Add authorization" })
                          ] }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "redirect-prod", className: "text-slate-100 focus:bg-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: "Prod to Dev" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Redirect to dev server" })
                          ] }) })
                        ] })
                      ] })
                    ] })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-slate-200", children: "Rule Type" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-3 bg-slate-700", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        TabsTrigger,
                        {
                          value: "overrides",
                    ...
                    lockedTab && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-cyan-400 mt-1", children: [
                      "Template selected - rule type is locked to ",
                      lockedTab
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "source-url", className: "text-slate-200", children: "Source URL Pattern" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        id: "source-url",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400", children: "Use * as wildcard, e.g., https://api.example.com/* matches all paths" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "description", className: "text-slate-200", children: "Description" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        id: "description",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "redirect", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "destination-url", className: "text-slate-200", children: "Destination URL" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400", children: "Use $1, $2, etc. to reference captured groups from the source URL" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 p-3 bg-slate-700/30 border border-slate-600 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400 text-center", children: "🚧 URL Redirection feature is coming soon! Stay tuned for updates." }) })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "headers", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-slate-200", children: "Headers" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "outline",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "mr-2 h-3 w-3" }),
                          " Add Header"
                        ]
                      }
                    )
                  ] }),
                  activeRule.headers && activeRule.headers.map((header, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-12 gap-2 items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        value: header.operation,
                        onValueChange: (value) => updateNestedField("headers", index2, "operation", value),
                        disabled: true,
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "bg-slate-700/50 border-slate-600 text-slate-400 cursor-not-allowed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Operation" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-slate-800 border-slate-600", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "add", className: "text-slate-100", children: "Add" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "modify", className: "text-slate-100", children: "Modify" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "remove", className: "text-slate-100", children: "Remove" })
                          ] })
                        ]
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: header.name,
                        onChange: (e) => updateNestedField("headers", index2, "name", e.target.value),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: header.value,
                        onChange: (e) => updateNestedField("headers", index2, "value", e.target.value),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 p-3 bg-slate-700/30 border border-slate-600 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400 text-center", children: "🚧 Header Modification feature is coming soon! Stay tuned for updates." }) })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "overrides", className: "space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "status-code", className: "text-slate-200", children: "Status Code" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "status-code",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 mt-6 pt-6 border-t border-slate-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                onClick: saveRule,
                disabled: (activeRule == null ? void 0 : activeRule.type) !== "overrides",
                className: `${(activeRule == null ? void 0 : activeRule.type) !== "overrides" ? "bg-slate-600 text-slate-400 cursor-not-allowed" : "bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-500 hover:to-blue-600 text-slate-900"} font-semibold shadow-lg shadow-cyan-500/25`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "mr-2 h-4 w-4" }),
                  (activeRule == null ? void 0 : activeRule.type) !== "overrides" ? "Coming Soon" : "Save Rule"
                ]
              }
            )
          ] })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-slate-800 border-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileJson, { className: "h-16 w-16 mx-auto text-slate-400 mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-slate-100 mb-2", children: "Welcome to Interzept" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 mb-6 max-w-md mx-auto", children: "Create your first rule to start intercepting and modifying API requests. Choose from templates or create custom rules." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            onClick: handleNewRule,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/icons/icon48.png", alt: "Interzept", className: "h-8 w-8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-white", children: "Interzept" })
          ] }),
